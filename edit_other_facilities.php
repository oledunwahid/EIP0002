...
<form action="function/update_ga_other_facilities.php" method="POST" enctype="multipart/form-data">
    <div class="row">
        <div class="col-lg-12">
                    ...
                    <div class="card-body pb-4 mb-5">
                        <div class="col-md">
                            <div class="row align-items-center">
                                ...
                                <div class="col-md">
                                    <input type="text" hidden name="id_ga_other_facilities" value="<?= $row['id_ga_other_facilities'] ?>">
                                    <input type="text" hidden name="wa" value="<?= $row['whatsapp'] ?>">
                                    <h4 class="fw-semibold" id="ticket-title">#<?= $row['id_ga_other_facilities'] ?> - Other Facilities Ticket </h4>
                                    <div class="hstack gap-3 flex-wrap">
                                        ...
                                        <div>
                                            <select class="form-control" data-choices name="statusOther">
                                                <?php
                                                $statusOptions = [
                                                    'Closed',
                                                    'On Process',
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="col-md-8 pb-3">
                        <div class="card-body">
                            <button type="submit" class="btn btn-primary col-md-3" name="updateOther">Update</button>
                            <a href="#" class="btn btn-danger col-md-3" name="deleteOther" id="delete-form">Delete</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        deleteButton.addEventListener('click', function(event) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = 'function/delete_ga_other_facilities.php?aksi=deleteOther&id=<?= $_GET['id'] ?>';
                }
            });
        });
    });
